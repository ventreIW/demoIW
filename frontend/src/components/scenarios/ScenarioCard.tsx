...
export default function ScenarioCard({ scenario, isActive, onActivate, isActivating }: ScenarioCardProps) {
  ...
  return (
    <Card className={isActive ? "ring-2 ring-primary" : ""}>
      ...
      <CardFooter>
        {isActive ? (
          <span className="text-sm font-medium text-primary">Activo</span>
        ) : (
          <Button
