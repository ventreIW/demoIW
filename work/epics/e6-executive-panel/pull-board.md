...
| s6.4 | NL query — frontend | — | backlog | Blocked on s6.2 + s6.3 |

**WIP limit:** 2 in-progress per epic (GR-PROC-003).
**Cut line:** if M2 has not landed by 2026-08-09, s6.3/s6.4 are cut and E7 starts — see `scope.md` §Sequencing risks.
