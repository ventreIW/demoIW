...
- [x] Comms launched from within case detail (RF-05.5) — s5.5
- [x] All tests pass (pytest + vitest); mypy + typecheck + lint + format clean — s5.5
- [x] All story retrospectives written; E2E covers list → detail → contact → draft — s5.5
...
|| s5.5 | — | **done** ✓ | 2026-08-03 | 2026-08-03 | Communications generator frontend — CommunicationsGenerator component with channel/tone selector, editable draft, explicit send confirmation, integrated into CaseDetail. 199 frontend tests added. All gates pass. |
